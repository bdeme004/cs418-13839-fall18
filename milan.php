...
function fetch_messages ($conn) {
    $sql="SELECT * FROM channel4 ORDER BY chKey DESC";
...
<form action="milan.php" method="post">
  <fieldset>
    Message:<br>
...
$sql="INSERT INTO channel4 VALUES ('DNE', '".$newmess."', now(), now(4));";
if($conn->query($sql)){
    fetch_messages($conn);
}
else {

...
<head>
<meta charset="UTF-8">
<title>Light Sky - lptColors</title>
...
<form action="lightSky.php" method="post" autocomplete="off">
  <fieldset>
    Message:<br>
...
$stmt="INSERT INTO channel5 (user, body) VALUES (?, ?)";
